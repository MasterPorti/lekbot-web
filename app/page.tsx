        ...
        <div className="relative z-[1]">
          ...
          <section className="banner-shipping bg-[#dc2a36] py-5 px-6">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-3 text-white text-center">
              ...
              <p className="text-sm md:text-base font-semibold tracking-wide">
                Envío <strong>gratis</strong> a toda la República Mexicana en
                todos los pedidos.
              </p>
              <a
                href="#comprar"
          ...
          >
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              <p className="text-gray-400 text-base md:text-lg mb-10 max-w-xl mx-auto">
                Las primeras{" "}
                <strong className="text-white">100 unidades</strong> salen con
                precio especial de introducción. No pierdas tu lugar.
              </p>
              ...
              <p className="text-gray-600 text-xs mt-6">
                Precio válido para las primeras 100 unidades · IVA incluido ·
                Envío gratis
              </p>
            </div>
          </section>
          ...
          <section className="bg-black py-5 px-6">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-3 text-white text-center">
              ...
              />
              <p className="text-sm md:text-base font-semibold tracking-wide">
                Conoce a <strong>nuestro creador</strong> y la historia detrás
                del Lek 2.
              </p>
              <a
                href="#video"
          ...
          {/* QUIÉNES SOMOS */}
          <section id="quienes-somos" className="about-section py-24 px-6">
              ...
              <div className="testimonials-grid grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  ...
                  >
                    <Quote
                      size={24}
                      className="text-[#dc2a36] opacity-30 mb-3"
                    />
            ...
            <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 text-center sm:text-left">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Si no te convence, te devolvemos el 100% de tu dinero. Sin
                  preguntas.
                </p>
              </div>
            </div>
